...
### Shelly switches, dimmers and sensors
Keys generated by the [Signal K Shelly plugin](https://www.npmjs.com/package/signalk-shelly) are mapped to switches and dimmers:
...
#### Prerequisite:
[Signal K Shelly plugin](https://www.npmjs.com/package/signalk-shelly)
...
These are especially keys generated by standard N2K PGNs, the [Signal K N2K Switching-Translator plugin](https://www.npmjs.com/package/signalk-n2k-switching-translator) or the [Signal K N2K Switching plugin](https://www.npmjs.com/package/signalk-n2k-switching). Known supported devices: Yacht Devices Circuit Control YDCC-04, Yacht Devices Switch Control and Maretron DCR100
